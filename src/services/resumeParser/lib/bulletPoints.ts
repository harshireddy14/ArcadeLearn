/**
 * Bullet Points Helper Library
 * Based on OpenResume's bullet-points.ts
 * Reference: https://github.com/xitanggg/open-resume/blob/main/src/app/lib/parse-resume-from-pdf/extract-resume-from-sections/lib/bullet-points.ts
 */

import type { Lines, TextItem } from "@/types/resume";
